...
export const collaborations: Collaboration[] = [
  ...
  },
  {
    id: "3",
    photo: "/formation.png",  // Modifié de 'image' à 'photo'
    company: "FormaPro",  // Modifié de 'compagne' à 'company'
    name: "Formation professionnelle adaptée",
    remarks:
      "Échanges d'expertise en formation professionnelle et co-création de programmes de formation adaptés aux besoins du marché du travail.",  // Modifié de 'description' à 'remarks'
    startDate: new Date("2024-03-01"),
  ...
  },
  {
    id: "4",
    photo: "/formation.png",  // Modifié de 'image' à 'photo'
    company: "InnovLab",  // Modifié de 'compagne' à 'company'
    name: "Projets innovants en laboratoire",
    remarks:
      "Partenariat pour l'accès à des équipements de pointe et la réalisation de projets innovants dans un environnement de laboratoire.",  // Modifié de 'description' à 'remarks'
    startDate: new Date("2024-04-01"),
  ...
  },
  {
    id: "5",
    photo: "/formation.png",  // Modifié de 'image' à 'photo'
    company: "GlobalEdu",  // Modifié de 'compagne' à 'company'
    name: "Échanges internationaux éducatifs",
    remarks:
      "Collaboration internationale pour des échanges d'étudiants et de professeurs, offrant une expérience multiculturelle enrichissante.",  // Modifié de 'description' à 'remarks'
    startDate: new Date("2024-05-01"),
...
export const messages: Message[] = [
  {
    ...
    message: "Bonjour, je suis intéressé par vos formations en technologies émergentes.",
    date: new Date("2024-12-15"),
    open: true, // Attribut ajouté
  },
  {
    id: "2",
    name: "Marie Curie",
    email: "marie.curie@example.com",
    message: "Pouvez-vous m'envoyer plus d'informations sur les logiciels éducatifs?",
    date: new Date("2024-12-14"),
    open: false, // Attribut ajouté
  },
  {
    id: "3",
    name: "Albert Einstein",
    email: "albert.einstein@example.com",
    message: "Je souhaite participer à vos échanges internationaux éducatifs. Merci de me recontacter.",
  ...
  },
  {
    ...
    message: "Y a-t-il des prérequis pour les projets en laboratoire ?",
  ...
  },
  {
    ...
    message: "Merci pour votre réponse rapide concernant la formation professionnelle adaptée.",
